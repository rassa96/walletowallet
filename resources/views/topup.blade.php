    ...
    <div class="tf-container">
        <div class="mt-24 pb-100">
            ...
            <div class="wg-total-asset-card mb-24">
                <div class="top-card">
                    <div class="text text-small fw-5">Current Balance</div>
            ...
            <form action="{{ route('wallet.topup.process') }}" method="POST">
                ...
                <!-- Amount -->
                <div class="mb-24">
                    <label class="text-medium fw-6 mb-8 d-block">Enter Amount ($)</label>
                ...
                <div class="mb-24">
                    ...
                    <div class="d-flex flex-wrap g-8">
                        ...
                        <button type="button" class="tf-btn style-2 py-10 style-white quick-amount" data-amount="250">$250</button>
                        <button type="button" class="tf-btn style-2 py-10 style-white quick-amount" data-amount="500">$500</button>
                    </div>
                </div>
